...
use contextual_hashbrown::hash_map as base;
...
pub struct HashMap<K, V, C = NoContext, S = RandomState> {
    base: base::HashMap<K, V, C, S>,
}

impl<K, V, C> HashMap<K, V, C, RandomState> {
    ...
    #[inline]
    #[must_use]
    pub fn new(context: C) -> HashMap<K, V, C, RandomState> {
        Self { base: base::HashMap::with_hasher(context, Default::default()) }
    }
    ...
    #[inline]
    #[must_use]
    pub fn with_capacity(context: C, capacity: usize) -> HashMap<K, V, C, RandomState> {
        HashMap::with_capacity_and_hasher(context, capacity, Default::default())
    }
}

impl<K, V, C, S> HashMap<K, V, C, S> {
    decorate_if! {
        ...
        fn with_hasher(context: C, hash_builder: S) -> HashMap<K, V, C, S> {
            HashMap { base: base::HashMap::with_hasher(context, hash_builder) }
        }
    }
    ...
    /// ```
    #[inline]
    pub fn with_capacity_and_hasher(context: C, capacity: usize, hasher: S) -> HashMap<K, V, C, S> {
        HashMap { base: base::HashMap::with_capacity_and_hasher(context, capacity, hasher) }
    }
    ...
    S: BuildHasher,
{
    ...
    pub fn raw_entry_mut(&mut self) -> RawEntryBuilderMut<'_, K, V, C, S> {
    ...
    #[inline]
    #[cfg(feature = "hash_raw_entry")]
    pub fn raw_entry(&self) -> RawEntryBuilder<'_, K, V, C, S> {
        RawEntryBuilder { map: self }
    }
}

impl<K, V, C, S> Clone for HashMap<K, V, C, S>
where
    K: Clone,
    V: Clone,
    C: Clone,
...
impl<K, V, C, S> PartialEq for HashMap<K, V, C, S>
where
    K: ContextualBorrow<K, C> + ContextualEq<C> + Hash,
    V: PartialEq,
    S: BuildHasher,
{
    fn eq(&self, other: &HashMap<K, V, C, S>) -> bool {
...
impl<K, V, C, S> Eq for HashMap<K, V, C, S>
where
    K: ContextualBorrow<K, C> + ContextualEq<C> + Hash,
    V: Eq,
    S: BuildHasher,
...
impl<K, V, C, S> Debug for HashMap<K, V, C, S>
where
    K: Debug,
    V: Debug,
{
...
impl<K, V, C, S> Default for HashMap<K, V, C, S>
where
    C: Default,
    S: Default,
{
    ...
    #[inline]
    fn default() -> HashMap<K, V, C, S> {
        HashMap::with_hasher(Default::default(), Default::default())
    }
}

impl<K, Q: ?Sized, V, C, S> Index<&Q> for HashMap<K, V, C, S>
where
    K: ContextualEq<C> + Hash + ContextualBorrow<Q, C>,
    Q: ContextualEq<C> + Hash,
    S: BuildHasher,
{
    type Output = V;
...
impl<K, V, C, const N: usize> From<[(K, V); N]> for HashMap<K, V, C, RandomState>
where
    K: ContextualEq<C> + Hash,
    C: Default,
{
...
#[cfg(feature = "hash_raw_entry")]
pub struct RawEntryBuilderMut<'a, K: 'a, V: 'a, C, S: 'a> {
    map: &'a mut HashMap<K, V, C, S>,
}
...
#[cfg(feature = "hash_raw_entry")]
pub struct RawEntryBuilder<'a, K: 'a, V: 'a, C, S: 'a> {
    map: &'a HashMap<K, V, C, S>,
}

#[cfg(feature = "hash_raw_entry")]
impl<'a, K, V, C, S> RawEntryBuilderMut<'a, K, V, C, S>
where
    S: BuildHasher,
{
...
#[cfg(feature = "hash_raw_entry")]
impl<'a, K, V, C, S> RawEntryBuilder<'a, K, V, C, S>
where
    S: BuildHasher,
{
...
#[cfg(feature = "hash_raw_entry")]
impl<K, V, C, S> Debug for RawEntryBuilderMut<'_, K, V, C, S> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg(feature = "hash_raw_entry")]
impl<K, V, C, S> Debug for RawEntryBuilder<'_, K, V, C, S> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("RawEntryBuilder").finish_non_exhaustive()
    }
}
...
impl<'a, K, V, C, S> IntoIterator for &'a HashMap<K, V, C, S> {
    type Item = (&'a K, &'a V);
...
impl<'a, K, V, C, S> IntoIterator for &'a mut HashMap<K, V, C, S> {
...
impl<K, V, C, S> IntoIterator for HashMap<K, V, C, S> {
    type Item = (K, V);
...
impl<K, V, C, S> FromIterator<(K, V)> for HashMap<K, V, C, S>
where
    K: ContextualEq<C> + Hash,
    C: Default,
    S: BuildHasher + Default,
{
    fn from_iter<T: IntoIterator<Item = (K, V)>>(iter: T) -> HashMap<K, V, C, S> {
        let mut map = HashMap::with_hasher(Default::default(), Default::default());
        map.extend(iter);
        map
    }
}
...
impl<K, V, C, S> Extend<(K, V)> for HashMap<K, V, C, S>
where
    K: ContextualEq<C> + Hash,
    S: BuildHasher,
{
...
impl<'a, K, V, C, S> Extend<(&'a K, &'a V)> for HashMap<K, V, C, S>
where
    K: ContextualEq<C> + Hash + Copy,
    V: Copy,
    S: BuildHasher,
{
    #[inline]
...
#[inline]
pub(super) fn map_try_reserve_error(err: contextual_hashbrown::TryReserveError) -> TryReserveError {
    match err {
        contextual_hashbrown::TryReserveError::CapacityOverflow => {
            TryReserveErrorKind::CapacityOverflow.into()
        }
        contextual_hashbrown::TryReserveError::AllocError { layout } => {
