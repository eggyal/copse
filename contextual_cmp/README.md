...
This crate defines a single feature flag, [`is_sorted`], which enables iterator the contextual
analogues of standard library [`Iterator`] methods that are gated behind a feature flag of the
same name.
...
[`NoContext`]: https://docs.rs/crate/contextual_cmp/latest/struct.NoContext.html
[`is_sorted`]: https://docs.rs/crate/contextual_cmp/latest/features#is_sorted
